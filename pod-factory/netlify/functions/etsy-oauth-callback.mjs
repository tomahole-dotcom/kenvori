...
export default async(req)=>{
 ...
 // Deliberately do not expose token values. Runtime env cannot be persistently mutated from a function.
 return new Response(`<!doctype html><meta name=viewport content="width=device-width"><style>body{font-family:system-ui;max-width:650px;margin:40px auto;padding:20px}</style><h1>Etsy authorization successful</h1><p>Scopes granted: ${String(d.scope||"").replaceAll("<","&lt;")}</p><p>Access token received and validated, but not persisted. Close this page and return to ChatGPT.</p>`,{headers:{"Content-Type":"text/html;charset=utf-8","Set-Cookie":"etsy_pkce=; Max-Age=0; Path=/; HttpOnly; Secure; SameSite=Lax"}});
};