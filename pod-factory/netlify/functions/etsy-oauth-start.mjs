...
export default async()=>{
 ...
 const q=new URLSearchParams({response_type:"code",redirect_uri:REDIRECT,scope:"listings_r listings_w shops_r shops_w",client_id:client,state,code_challenge:challenge,code_challenge_method:"S256"});
