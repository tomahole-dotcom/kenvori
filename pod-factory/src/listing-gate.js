...
export function finalFactoryGate(x={}){
 const checks=["researchApproved","commercialOpportunityApproved","creativeApproved","productFitApproved","economicsApproved","artworkQaPass","printifyQaPass","ipGreen","listingIntelligenceApproved","etsyPackageReady","shippingVerified","productionPartnerVerified"];
