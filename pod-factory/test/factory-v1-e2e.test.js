...
test("Factory V1 end-to-end reaches safe publish gate",()=>{const creativeEvidence={researchFit:85,originality:85,visualImpact:80,productBreadth:80,productionFit:85,ipSafety:95,distinctiveness:85,hookStrength:85};const theme="whimsical polka dots";
 const signals=[{source:"research",query:"original trend",audience:"buyers",theme,searchInterest:92,growth:35,competition:20,priceMedian:32,reviewVelocity:80}];
 const products=[{name:"phone case",theme,researchEvidence:85,designFit:90,marginPotential:80,priceCents:3200,productionCostCents:600,shippingCostCents:0,blueprintId:268,providerId:1,variantId:63360,variantIds:[63360]}];
